...
function daily_sales()
{
    ...
    if (isset($_SESSION['admin'])) {
        ...
        <div class="navbar_heading">
            <h4 style="margin: 0; text-align: center;"><b>Daily Sales</b></h4>
        ...
        <div class="checkbox-wrapper-10">
            ...
            <label for="cb5" data-tg-on="Online" data-tg-off="Direct" class="tgl-btn"></label>
        </div>
    </form>
            </div>
        </div>
        ...
        if(isset($_POST['type']))
        {
            $select_qry = "SELECT * FROM user_order WHERE DATE(d_date) = CURDATE()";

        }
        else
        {
            $select_qry="SELECT * FROM order_off  WHERE DATE(order_date) = CURDATE()";
        }
