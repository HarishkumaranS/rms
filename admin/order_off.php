...
function offline_order()
{
    if (isset($_SESSION['admin'])) {
        ...
        ?>
        <h4 align="center"><b>Direct Order</b></h4>
        ...
        if (isset($_POST['submit'])) {
            ...
            } elseif ($_POST['select'] == 'date') {
                $date = $_POST['value'];
                $add_qry = " order_date='$date'";
            ...
            window.location.href='index.php?off_order';</script>";
                ...
                if ($num == 1) {
                    ...
                    echo "<script>alert('More than one product like $product_name');
            window.location.href='index.php?off_order';</script>";
                } else {
        ...
        if (isset($add_qry)) {
            ...
            $select_qry = "SELECT * FROM order_off order by order_date DESC";
        }
        ...
        if ($num > 0) {
            ...
            while ($row = mysqli_fetch_array($result_select)) {
                ...
                $service = $row['service'];
                $select_qry_join = "SELECT c.cust_name,p.product_name from product p,customer c where c.cust_id=$cust_id and p.product_id=$product_id ";
                ...
                $data[] = [$date, $time, $cust_name, $product_name, $qty, $price, $service];
            }
            ?>
