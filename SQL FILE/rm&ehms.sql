...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2025 at 06:26 AM
...
INSERT INTO `admin` (`a_id`, `user_name`, `password`, `login`) VALUES
(1, 'Harishkumaran', 'Harishkumaran@29', 'admin'),
(2, 'Thaiyanban', 'Thaiyanban@2005', 'admin'),
(3, 'Tharun', 'Tharun@2005', 'biller');
...
(5, 13, 3, 2, 384.00, 768.00, 400.00, 800.00);
...
(56, 8, 3, 2, 128, 0, '2025-02-20 20:25:12', '2025-02-20 21:25:12'),
...
--
ALTER TABLE `event_booking`
  MODIFY `b_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT for table `fav`
--
ALTER TABLE `fav`
  MODIFY `fav_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `order_off`
--
ALTER TABLE `order_off`
  MODIFY `o_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `user_order`
  MODIFY `o_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
COMMIT;
