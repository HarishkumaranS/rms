...
function view_del_event(): void
{
    if (isset($_SESSION['admin'])) {
        ...
        if ($num > 0) {
            echo "<table align='center' class='table table-striped table-light'><thead class='thead-dark'><tr><th scope='col'>S.NO</th><th scope='col'>Event Name</th><th scope='col'>Cost</th><th scope='col'>Delete</th></tr></thead><tbody>";
           $s_no=0;
            while ($row = mysqli_fetch_array($result)) {
                ...
                $e_name = $row['e_name'];
                $e_cost = $row['e_cost'];
                echo "<tr><td scope='row'>$s_no</td><td>$e_name</td><td>$e_cost</td><td><a onclick='rdel_event($e_id)'><i class='fa-solid fa-trash-arrow-up del_color'></i></a></td></tr>";
            }
            echo "</tbody></table>";
        } else {
...
if (isset($_GET['EUDid'])) {
    $e_id = $_GET['EUDid'];
    // del qry
    $del_qry = "UPDATE event SET status=1 WHERE e_id='$e_id'";
