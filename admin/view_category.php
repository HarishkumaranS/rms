    ...
    if (isset($_SESSION['admin']) || isset($_SESSION['biller'])) {
        ...
        <div class="navbar_heading">
            ...
            <div style="position: absolute; top: 50%; right: 0; transform: translateY(-50%);">
                <a href="index.php?insert_cat" class="add_btn text-decoration-none">+ ADD</a>
                <a href="index.php?view_del_cat" class="delete_btn text-decoration-none">Del Product</a>
            </div>
            <?php } ?>
        </div>
        <?php
        ...
        if ($num > 0) {
            ...
            while ($row = mysqli_fetch_array($result_cat)) {
                ...
                $data[] = [
                    $cat_name,
                     isset($_SESSION['admin']) ? "<a href='index.php?CEid=$cat_id'><i class='fa-solid fa-pen-to-square edit_color'></i></a>" : null,
                     isset($_SESSION['admin']) ? "<a onclick='del_cat($cat_id)'><i class='fa-solid fa-trash del_color'></i></a>" : null
                ];
            }
            // print_r($data);
            ?>
